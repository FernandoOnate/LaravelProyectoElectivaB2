...
@section('content_header')
    <h1>Sección de editar productos | Esquina Verde</h1>
@stop

@section('content')
    <div class="card">
        <div class="card-body">
            {!! Form::model($producto,['route' => ['admin.productos.update',$producto],'enctype'=>'multipart/form-data','files'=>'true','method'=>'put'])!!}
            ...
            <a href="{{route('admin.productos.index')}}" class="btn btn-primary btn-sm">Regresar</a>
